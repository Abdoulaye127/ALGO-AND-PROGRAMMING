...
/////////////////////// START HEAP SORT ///////////////////////
        ...
        void manuallyEnterElements(std::vector<int>& arr) {
        ...
        void generateRandomElements(std::vector<int>& arr) {
...
int main() {
    ...
    std::cout << "Enter 1 to manually enter elements or 2 to generate random elements: ";
    std::cin >> choice;
